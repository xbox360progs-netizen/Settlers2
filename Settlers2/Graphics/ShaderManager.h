...
enum ShaderID {
    ...
    SHADER_WORLD = 5,
    SHADER_ENTITY = 6,
    SHADER_DEFERRED_LIGHTING = 7,
    SHADER_SPRITE_GBUFFER = 8,
    SHADER_SPRITE_ALPHATEST = 9,
    SHADER_SPRITE_EMISSIVE = 10,
    SHADER_SPRITE_PBR = 11,
    SHADER_COUNT
};
...
public:
    ...
    // Helper for sequential command allocation
    int FindFreeSlot();
...
public:
    ...
    volatile LONG m_commandCounter; // Counter for sequential command allocation
private:
